const presencePopup = document.getElementsByClassName("PresencePopup popup popup-select arrow up")[0];
const availabilityButton = document.getElementsByClassName("Me-availabilityText Me-availabilityTextAnchor")[0];
...
const editMoodContainer = document.getElementsByClassName("Me-moodMessage-editMoodContainer")[0];
const moodMessage = document.getElementById("moodMessage");

const saveMoodEdit = document.getElementsByClassName("Me-moodMessage-editMoodContainer--button iconfont ok")[0];
const cancelMoodEdit = document.getElementsByClassName("Me-moodMessage-editMoodContainer--button iconfont cancel")[0];

const buttonEditMood = document.getElementsByClassName("Me-moodMessage-editButton iconfont edit")[0];
...
const avatarPresenceIndicator = document.getElementById("avatarPresenceIndicator");
const userStatusIndicator = document.getElementsByClassName("Me-availability")[0];
...
setPresenceOnline.addEventListener("click", (event) => {
  avatarPresenceIndicator.className = "Avatar Avatar--size260 Avatar--presence Avatar--online";
...
setPresenceAway.addEventListener("click", (event) => {
  avatarPresenceIndicator.className = "Avatar Avatar--size260 Avatar--presence Avatar--idle";
...
setPresenceDND.addEventListener("click", (event) => {
  avatarPresenceIndicator.className = "Avatar Avatar--size260 Avatar--presence Avatar--donotdisturb";
...
setPresenceInvisible.addEventListener("click", (event) => {
  avatarPresenceIndicator.className = "Avatar Avatar--size260 Avatar--presence Avatar--offline";
